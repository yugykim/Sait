    ...
    reserveButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        if (selectedFlight.getSeats() > 0) {
          if (nameJField.getText().equals("") || citizenshipJField.getText().equals("") || selectedFlight == null) {
            JOptionPane.showMessageDialog(containerPanel, "Flight schedule, name and citizenship field are required.");
          } else {
            reservationManager.makeReservation(flightsList, nameJField.getText(), citizenshipJField.getText());
