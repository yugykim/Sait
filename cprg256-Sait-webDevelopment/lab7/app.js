  ...
  function displayInfo() {
    ...
    for (var i=0; i < form.length; i++){
      for (var k=1; k < form[i].length; k++){
        ...
        <br /> First name: ${form[i][k][0].Firstname} <br /> Last name: ${form[i][k][0].Lastname} <br /> Address: ${form[i][k][0].Address} <br /> PostalCode: ${form[i][k][0].PostalCode} 
        <br /> Home Type: ${form[i][k][0].HomeType} <br /> Income: ${form[i][k][0].Income} <br /> Select Items: ${form[i][k][0].SelectItems} <br /> current Status: ${form[i][k][0].currentStatus}
        <br /> Email:  ${form[i][k][0].Email} <br /> PhoneType: ${form[i][k][0].PhoneType} <br /> PhoneNumber: ${form[i][k][0].PhoneNumber} <br /> AGE: ${form[i][k][0].age}<p>`;
      }
    }
  }
